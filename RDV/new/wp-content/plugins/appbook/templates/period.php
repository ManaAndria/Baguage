...
?>
	<div class="panel panel-default" id="employee-<?php echo $employee->employee_id ?>">
	  	...
	  	<div class="panel-body">
	  		<div class="pull-left">
	  			<div class="text-info"><?php echo __('La durée du service est de ', $app->slug).'<span class="label label-primary">'.$app->app->service->getFieldById($employee->poste, 'duration').' '.__('minutes', $app->slug).'</span>.'; ?></div>
	  	...
	  	?>
		    <li id="<?php echo $period['period_id'] ?>" class="list-group-item">
		    	<span class="pull-left"><?php echo $period_text ?></span>
		    	<div class="pull-right">
