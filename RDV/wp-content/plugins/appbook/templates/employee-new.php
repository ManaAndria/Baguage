...
<form id="<?php echo $app->slug; ?>_app<?php echo '_'.$form_action?>"  class="<?php echo $app->slug; ?>_form form-horizontal col-xs-12 col-sm-8" method="POST" action="">
	...
	<div class="form-group">
	    <label for="poste" class="col-xs-12 col-sm-4 control-label"><?php echo __('Poste', $app->slug) ?> *</label>
	    <div class="col-xs-12 col-sm-8">
	    	<select class="form-control" name="<?php echo $form_action; ?>[poste]" id="poste">
	    		<option value="">-</option>
	    		<?php
	    		if ($current)
	    			$selected = $current->poste;
	    		else
	    			$selected = '';
