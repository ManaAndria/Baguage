...
if (is_user_logged_in())
{
	...
	<div class="col-xs-12">
		...
		<form id="<?php echo $app->slug; ?>_app<?php echo '_'.$form_action2?>"  class="<?php echo $app->slug; ?>_form form-horizontal" method="POST" action="">
			...
			<div class="form-group">
			    <label for="password" class="col-xs-12 col-md-4 control-label"><?php echo __('Mot de passe', $app->slug) ?> *</label>
			    <div class="col-xs-12 col-md-8">
			    	<input type="password" class="form-control" id="password" name="<?php echo $form_action2; ?>[password]" placeholder="<?php echo __('Mot de passe', $app->slug) ?>" required />
		    	</div>
		  	</div>
			<div class="form-group">
			    <label for="user_confirm_password" class="col-xs-12 col-md-4 control-label"><?php echo __('Confirmation du mot de passe', $app->slug) ?> *</label>
			    <div class="col-xs-12 col-md-8">
			    	<input type="password" class="form-control" id="user_confirm_password" name="<?php echo $form_action2; ?>[user_confirm_password]" placeholder="<?php echo __('Confirmation du mot de passe', $app->slug) ?>" required />
		    	</div>
		  	</div>
		  	<div class="control-group">
				<div class="col-xs-12 col-md-offset-4 col-md-8">
